...
<div>
    <header class="container px-0 my-4">
        <div class="row col-12 d-flex px-0 mx-0">
            ...
            <div class="d-flex align-items-center
                                    col-12 pt-3
                                    col-xl-5 pl-xl-4 px-xl-0
                                    col-lg-5 pl-lg-5 pr-lg-0 px-lg-0 pt-lg-0
                                    col-md-7 px-md-0
                                    pt-sm-3 ">
                <div class="dropdown">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Search for Item..." aria-label="Recipient's username" aria-describedby="basic-addon2">
                    ...
                    <div class="headerCartWrap">
                        ...
                        <div class="headerCartWrapInAll">
                            <div class="d-flex headerCartWrapIn">
                                <a href="#" class="d-flex ">
                                    <img src="https://raw.githubusercontent.com/kellolo/static/master/img/JS1_shop/myAccount1.jpg" alt="">
                                    <div>
                                        <div>Rebox Zane</div>
                            ...
                            <div class="d-flex">
                                <a href="#" class="d-flex headerCartWrapIn">
                                    <img src="https://raw.githubusercontent.com/kellolo/static/master/img/JS1_shop/myAccount2.jpg" alt="">
                                    <div>
                                        <div>Rebox Zane</div>
                                        <span><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></span>
                                        <div class="headerCartWrapPrice">1 <span>x</span> $250</div>
        ...
        <div class="navAll">
            ...
            <div class="dropNav">
                ...
                <div class="dropNavIn">
                    ...
                    <a href="">
                        <div>Super sale!</div>
                        <img src="https://raw.githubusercontent.com/kellolo/static/master/img/JS1_shop/navDrop.jpg" alt="nav img">
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="topBanner">
        <div class="container topBannerContent px-sm-0">
            <div class="bgText">
                <a href="#">
                    <div class="topBannerText1">THE BRAND</div>
                </a>
                <a href="#">
                    <div class="topBannerText2">OF LUXERIOUS <span>FASHION</span></div>
                </a>
            </div>
        </div>
    </div>
    ...
    <main>
        <div class="container px-sm-0">
            ...
            <div class="offers row mt-5 pt-0 pt-lg-5">
                <div class="col-sm-6
                        col-10 offset-1 offset-sm-0">
                    <div class="offer">
                        <a href="#">
                            <div>hot deal</div>
                            <div>for men</div>
                        </a>
                        <a href="#"><img src="https://raw.githubusercontent.com/kellolo/static/master/img/JS1_shop/offer1.jpg" alt=""></a>
                    </div>
                    ...
                    <div class="offer mt-4">
                        ...
                        <a href="#"><img src="https://raw.githubusercontent.com/kellolo/static/master/img/JS1_shop/offer2.jpg" alt=""></a>
                    </div>
                </div>

                <div class="col-10 offset-1 offset-sm-0 col-sm-6 d-flex flex-wrap">
                    <div class="offer order-2 mt-4 mt-md-0 order-md-1">
                        <a href="#">
                            <div>30% offer</div>
                            <div>women</div>
                        </a>
                        <a class="one" href="#"><img src="https://raw.githubusercontent.com/kellolo/static/master/img/JS1_shop/offer3.jpg" alt=""></a>
                    </div>

                    <div class="offer pt-4 pt-sm-0 order-1 order-md-2 mt-0 mt-md-4">
                        <a href="#">
                            <div>new arrivals</div>
                            <div>FOR kids</div>
                        </a>
                        <a class="one" href="#"><img src="https://raw.githubusercontent.com/kellolo/static/master/img/JS1_shop/offer4.jpg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="mt-5 d-flex flex-column justify-content-center align-items-center">
                <a href="#">
                    <div class="feturedHeadTop">Fetured Items</div>
                </a>
                <a href="#">
            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="offerWomenLeft px-0 d-flex justify-content-center
                            col-12 col-lg-8 justify-content-lg-start">

                        <div class="offerWomenBannerText">
                            <div>30% <span>OFFER</span></div>
                            <div>FOR WOMEN</div>
                        </div>
                    </div>
                    <div class="offerWomenRight d-flex flex-column px-0 col-12
                            col-lg-4">
                        ...
                        <div class="d-flex flex-column justify-content-center align-items-center
                            ...
                            <div class="offerWomenDetail">
                                ...
                                <div class="offerWomenDetailBottom">Worldwide delivery on all. Authorit tively morph
        ...
        <div class="row col-12 px-0 my-5 no-gutters">
            ...
            <div class="col-12 px-0
                ...
                <div class="d-flex flex-column flex-sm-row px-5 px-sm-0 flex-lg-column">
                    ...
                    <div class="footerBrandText pb-4">
